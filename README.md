...
jobs:
  plumber:
    ...
    steps:
      ...
      - uses: getplumber/plumber@6db7ae35b434071697bac46078e7670448c49740   # v0.3.14
        with:
          threshold: 80
```
...
|-------|---------|-------------|
| `version` | `v0.3.15` | Plumber release to install. Defaults to a pinned tag; bump explicitly when upgrading. |
