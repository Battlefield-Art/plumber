...
jobs:
  plumber:
    ...
    steps:
      ...
      - uses: getplumber/plumber@0ab75b8aa805fd11f9438097f804197bb4a0296f   # v0.3.22
        with:
          threshold: 80
```
...
|-------|---------|-------------|
| `version` | `v0.3.22` | Plumber release to install. Defaults to a pinned tag; bump explicitly when upgrading. |
