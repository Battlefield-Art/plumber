...
jobs:
  plumber:
    ...
    steps:
      ...
      - uses: getplumber/plumber@4d80971a3943cd57b50b57fe20884629f88bdd9a   # v0.3.20
        with:
          threshold: 80
```
...
|-------|---------|-------------|
| `version` | `v0.3.20` | Plumber release to install. Defaults to a pinned tag; bump explicitly when upgrading. |
