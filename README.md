...
jobs:
  plumber:
    ...
    steps:
      ...
      - uses: getplumber/plumber@c4c67eaa7e3bfedcf15b2dc51ba370f6b409e8a1   # v0.3.12
        with:
          threshold: 80
```
...
|-------|---------|-------------|
| `version` | `v0.3.12` | Plumber release to install. Defaults to a pinned tag; bump explicitly when upgrading. |
