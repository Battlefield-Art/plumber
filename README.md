...
jobs:
  plumber:
    ...
    steps:
      ...
      - uses: getplumber/plumber@6d1e3142499af4f082a1628fa972f2e5ead75810   # v0.3.24
        with:
          threshold: 80
```
...
|-------|---------|-------------|
| `version` | `v0.3.24` | Plumber release to install. Defaults to a pinned tag; bump explicitly when upgrading. |
