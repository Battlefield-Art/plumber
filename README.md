...
jobs:
  plumber:
    ...
    steps:
      ...
      - uses: getplumber/plumber@5dbe013ca71aa83e1966249cdbb9a1fbe6acee16   # v0.3.26
        with:
          threshold: 80
```
...
|-------|---------|-------------|
| `version` | `v0.3.26` | Plumber release to install. Defaults to a pinned tag; bump explicitly when upgrading. |
