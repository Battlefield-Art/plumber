...
jobs:
  plumber:
    ...
    steps:
      ...
      - uses: getplumber/plumber@caa328f975107189372b47942c9fbf42aba28919   # v0.3.31
        with:
          threshold: 80
```
...
|-------|---------|-------------|
| `version` | `v0.3.32` | Plumber release to install. Defaults to a pinned tag; bump explicitly when upgrading. |
