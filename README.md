...
jobs:
  plumber:
    ...
    steps:
      ...
      - uses: getplumber/plumber@777673da30dc80262151a8e79e6f58a32429b8f1   # v0.3.23
        with:
          threshold: 80
```
...
|-------|---------|-------------|
| `version` | `v0.3.23` | Plumber release to install. Defaults to a pinned tag; bump explicitly when upgrading. |
