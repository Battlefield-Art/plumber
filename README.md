...
jobs:
  plumber:
    ...
    steps:
      ...
      - uses: getplumber/plumber@39c703615e0aacad1c4faa8f9e133bb7c528a819   # v0.3.16
        with:
          threshold: 80
```
...
|-------|---------|-------------|
| `version` | `v0.3.16` | Plumber release to install. Defaults to a pinned tag; bump explicitly when upgrading. |
