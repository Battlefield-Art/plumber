...
jobs:
  plumber:
    ...
    steps:
      ...
      - uses: getplumber/plumber@243ae46df3aa77aacd84e75590ac81bee261957c   # v0.3.25
        with:
          threshold: 80
```
...
|-------|---------|-------------|
| `version` | `v0.3.25` | Plumber release to install. Defaults to a pinned tag; bump explicitly when upgrading. |
