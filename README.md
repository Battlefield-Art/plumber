...
jobs:
  plumber:
    ...
    steps:
      ...
      - uses: getplumber/plumber@3474a39cd947da8717607a02ecd18b859487e5ed   # v0.3.13
        with:
          threshold: 80
```
...
|-------|---------|-------------|
| `version` | `v0.3.13` | Plumber release to install. Defaults to a pinned tag; bump explicitly when upgrading. |
