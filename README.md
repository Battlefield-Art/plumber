...
jobs:
  plumber:
    ...
    steps:
      ...
      - uses: getplumber/plumber@2df2bfe277645a3e604695583d99a0a26762271b   # v0.3.35
        with:
          threshold: 80
```
...
|-------|---------|-------------|
| `version` | `v0.3.36` | Plumber release to install. Defaults to a pinned tag; bump explicitly when upgrading. |
